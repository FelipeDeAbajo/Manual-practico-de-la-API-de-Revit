...
namespace BoundingBoxIsInside
{
    [Transaction(TransactionMode.Manual)]
    public class BoundingBoxIsInside : IExternalCommand
    {
          ...
          ElementSet elements)
        {
            ...
            // Use el filtro BoundingBoxInside filter para encontrar elementos con un cuadro
            // delimitador que este completamente dentro del Outline. 
            ...
            names.Insert(0, "Elementos que SI estan estan dentro del Outline");
            TaskDialog.Show("Manual Revit API", string.Join("\n", names));

            // Buscamos  elementos con BoundingBox que no intersectan el Outline. 

            BoundingBoxIsInsideFilter invertFilter = new BoundingBoxIsInsideFilter(myOutLn, true); // filtro inverso
            ...
            names.Insert(0, "Elementos que NO estan estan dentro del Outline");
            TaskDialog.Show("Manual Revit API", string.Join("\n", names));
